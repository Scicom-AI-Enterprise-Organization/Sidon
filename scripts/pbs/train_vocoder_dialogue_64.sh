...
export WANDB_NAME="dialogue_64_${PBS_JOBID}"
...
mpirun  \
  ...
  'model.cfg.vae_checkpoint_path="/home/qch10240fz/nakata/github.com/Sidon/sidon/0v0cvco1/checkpoints/epoch=0-step=500000.ckpt"'