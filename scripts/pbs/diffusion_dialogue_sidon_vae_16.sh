...
export WANDB_NAME="diffusion_dialogue_sidon_vae_16"
...
mpirun  \
  ...
  model.cfg.lora=true \
  'model.cfg.vae_checkpoint_path="/home/qch10240fz/nakata/github.com/Sidon/sidon/ndr78sk4/checkpoints/epoch=0-step=510000.ckpt"' \
  train=default \
